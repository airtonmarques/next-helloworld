...
translate((upper(be.nome_entidade)),'¡«…Õ”⁄¿»Ã“Ÿ¬ Œ‘€√’À‹','ACEIOUAEIOUAEIOUAOEU') nome_associado,
be.ind_sexo,
...
'01' nacionalidade,
translate((upper(be.nome_mae)),'¡«…Õ”⁄¿»Ã“Ÿ¬ Œ‘€√’À‹','ACEIOUAEIOUAEIOUAOEU') nome_mae,
'' vazio,
bend.num_cep cep,
translate((upper(bend.nom_logradouro)),'¡«…Õ”⁄¿»Ã“Ÿ¬ Œ‘€√’À‹','ACEIOUAEIOUAEIOUAOEU') logradouro,
