...
suc.nome_sucursal,
(select sys_get_vlr_cont_fe_fnc(2, ce.cod_ts_contrato, p.cod_plano, b.tipo_associado, SYS_GET_IDADE_FNC(be.data_nascimento, last_day('01/05/2022')), last_day('01/05/2022')) from dual) as VALOR_COMERCIAL,
(select sys_get_vlr_cont_fe_fnc(1, ce.cod_ts_contrato, p.cod_plano, b.tipo_associado, SYS_GET_IDADE_FNC(be.data_nascimento, last_day('01/05/2022')), last_day('01/05/2022')) from dual) as VALOR_NET,
...
and b.data_inclusao <= last_day('01/05/2022')
and nvl(b.data_exclusao, to_date('31/12/3000', 'DD/MM/YYYY')) > last_day('01/05/2022')
