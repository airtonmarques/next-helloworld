...
(select sys_get_vlr_cont_fe_fnc(2, ce.cod_ts_contrato, p.cod_plano, b.tipo_associado, SYS_GET_IDADE_FNC(be.data_nascimento, b.data_exclusao), b.data_exclusao) from dual)

as VALOR_COMERCIAL,

		 (select sys_get_vlr_cont_fe_fnc(1, ce.cod_ts_contrato, p.cod_plano, b.tipo_associado, SYS_GET_IDADE_FNC(be.data_nascimento, b.data_exclusao), b.data_exclusao) from dual)
 as VALOR_NET,
...
and b.data_exclusao between to_date('01/03/2023', 'dd/mm/yyyy') and last_day('01/03/2023')
