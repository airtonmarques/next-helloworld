select distinct adm.nom_operadora Administradora,
       ...
       (select count(1)
        from ts.cobranca c
        where c.dt_competencia between to_date('01/02/2022', 'dd/mm/yyyy')
              and last_day('01/02/2022')
       ...
       (select sys_get_vlr_cont_fe_fnc(2, ce.cod_ts_contrato, pl.cod_plano,
               b.tipo_associado, SYS_GET_IDADE_FNC(be.data_nascimento, last_day('01/07/2021')), last_day('01/07/2021')) from dual) as VALOR_COMERCIAL*/
...
where not exists (select 1
      ...
      and (b.data_exclusao is null or b.data_exclusao > last_day('01/02/2022'))
      and b.data_inclusao <= last_day('01/02/2022')
