...
where c.dt_cancelamento is null
      ...
      --and c.dt_competencia between to_date('01/02/2021', 'dd/mm/yyyy') and to_date('28/02/2021', 'dd/mm/yyyy')
      and c.dt_baixa between to_date('01/02/2021', 'dd/mm/yyyy') and last_day('01/02/2021')
